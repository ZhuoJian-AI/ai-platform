...
_BASELINE_MANAGED_INDEXES = {
    ...
    ("rag_chunks", "ix_rag_chunks_document_id"),
    ("skill_files", "ix_skill_files_folder"),
    ("skill_files", "ix_skill_files_skill_folder_id"),
    ("skill_files", "uq_skill_file_path_live"),
    ("skill_folders", "ix_skill_folders_active_version"),
    ("skill_folders", "ix_skill_folders_active_version_id"),
    ("skill_folders", "ix_skill_folders_organization_id"),
    ("skill_folders", "ix_skill_folders_org_scope"),
    ("skill_folders", "ix_skill_folders_scope_id"),
    ("skill_folders", "uq_skill_folder_scope_slug_live"),
    ("skill_versions", "ix_skill_versions_folder"),
    ("skill_versions", "ix_skill_versions_install_status"),
    ("skill_versions", "ix_skill_versions_skill_folder_id"),
    ("skill_versions", "ix_skill_versions_status"),
...
_BASELINE_MANAGED_UNIQUE_CONSTRAINTS = {
    ...
    ("skill_files", "uq_skill_file_path"),
    ("skill_folders", "uq_skill_folder_scope_slug"),
