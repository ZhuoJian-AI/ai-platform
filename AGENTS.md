...
分句播报后续候选分支 `feat/voice-sentence-stream-20260912` 已接通公开文字实时转发、Run 级持久语音片段、标准 TTS job 与有序播放；合成测试已验证首声早于模拟主脑结束。尚未真实 MiMo/数据库 worker/浏览器验收，未部署，不能宣称线上已支持边生成边播报。详见 `docs/handoff/2026-09-12_voice-stream-framing.md`。
